...
class Stringlifier:
    ...
    def _extract_tokens_2class(self, string: str, pred: NDArray[Shape["*"], Int64]) -> Tuple[str, List[Tuple[str, int, int]]]:
        CUTOFF = 5
        mask = ''
        for p in pred:
    ...
    def _extract_tokens(self, string: str, pred: NDArray[Shape["*"], Int64], cutoff: int = 5) -> Tuple[
